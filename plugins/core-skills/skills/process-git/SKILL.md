...
- Commit and PR messages should not indicate Generative AI co-authorship (e.g., no "Generated by Mistral Vibe" or "Co-Authored-By" lines in commit messages themselves; these belong only in PR descriptions as context)
